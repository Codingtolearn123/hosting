...
<section id="pricing" class="py-24 bg-slate-950">
    <div class="max-w-7xl mx-auto px-6 space-y-16">
        ...
        <div
            class="space-y-10"
            data-pricing-react
            data-plans='<?php echo esc_attr(wp_json_encode($shared_plans)); ?>'
            data-promo="<?php echo $one_dollar_enabled ? '1' : '0'; ?>"
        >
            <noscript>
                <div class="grid gap-8 lg:grid-cols-4">
                    ...
                    <?php else : ?>
                        <?php foreach ($shared_plans as $plan) : ?>
                            <article class="p-8 rounded-3xl border border-white/10 bg-slate-950/70 backdrop-blur-xl text-slate-200">
                                <h3 class="text-xl font-semibold text-white"><?php echo esc_html($plan['title']); ?></h3>
